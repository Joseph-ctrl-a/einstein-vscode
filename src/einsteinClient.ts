...
export async function checkAuth(username: string, password: string): Promise<void> {
...
function buildMultipart(boundary: string, fileName: string, content: Buffer): Buffer {
...
function httpsGet(url: string, username: string, password: string): Promise<{ statusCode: number; body: string }> {
